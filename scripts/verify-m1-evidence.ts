...
const INPUT_CLOSURE = Object.freeze([
  ...
  "scripts/m1-key-ambiguity-reference.ts",
  "src/application/runtime.ts",
  "src/ui/App.tsx",
  "src/ui/studio/MidiImportPanel.tsx",
  "src/ui/studio/studio-contract.ts",
  "tests/support/midi-key-ambiguity-fixture.ts",
  "tests/unit/m1-key-ambiguity-contract.test.ts",
  "tests/integration/m1-key-ambiguity.test.ts",
  "tests/e2e/m1-key-ambiguity.spec.ts",
  `${FIXTURE_DIR}/key-ambiguity-cases.json`,
  "src/application/studio-midi-import.ts",
  "src/application/studio-midi-audition.ts",
  "src/application/studio-audio.ts",
  "src/application/studio-controller.ts",
  "src/audio/transport.ts",
  "src/audio/transport-contract.ts",
  "tests/unit/m1-groove-audition.test.ts",
