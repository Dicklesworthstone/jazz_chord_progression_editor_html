...
const gates: Gate[] = [
  ...
  { id: "discovery-execution-evidence", command: [process.execPath, "scripts/verify-discovery-execution-evidence.ts"] },
  {
  ...
  {
    id: "u2-chord-inspector-contract",
    command: [process.execPath, "scripts/validate-u2-contract.ts"],
  },
  {
    id: "u4-transport-controls-contract",
