import { UI_LIMITS, type UiButtonProps } from "../ui-contract";
...
function requireButtonProps(props: UiButtonProps): void {
  ...
  if (
    ...
    const refusal = uiDiagnostic(
      ...
      props.id,
      ["variant"],
      "The button variant is outside the reviewed closed set.",
  ...
  if (
    ...
    const refusal = uiDiagnostic(
      ...
      props.id,
      ["type"],
      "The native button type is outside the reviewed closed set.",
  ...
  if (typeof props.onAction !== "function") {
    const refusal = uiDiagnostic(
      ...
      props.id,
      ["onAction"],
      "The button action callback is missing or malformed.",
