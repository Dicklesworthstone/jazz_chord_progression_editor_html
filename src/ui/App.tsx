...
export type AppActions = Readonly<{
  ...
  noteFirst?: Pick<StudioController,"readNoteFirst"|"insertNoteFirst"|"previewNoteFirst"|"releaseNoteFirst"|"readNoteFirstKeyboard"|"editNoteFirst">;
  ...
  return (
    ...
    <StudioShell
      ...
      {...(noteFirstActions === undefined ? {} : { noteFirst: {
        ...
        keys:noteFirstActions.readNoteFirstKeyboard,edit:noteFirstActions.editNoteFirst,
