  ...
  return Object.freeze({
    ...
    completeCanonicalExportMarkerSettlement: async (
      ...
      try {
        ...
        const prototype: unknown = isPlainRecord(startResult) ? Object.getPrototypeOf(startResult) : undefined;
        if ((prototype === Object.prototype || prototype === null) &&
            isPlainRecord(startResult) && Reflect.ownKeys(startResult).length === 1) {
