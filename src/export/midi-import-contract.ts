...
import {
  REVERSE_CHORD_TEMPLATES as MIDI_IMPORT_MATCH_TEMPLATES,
  type ReverseChordTemplate,
 ...
 */
export type MidiImportMatchTemplate = ReverseChordTemplate;
export { MIDI_IMPORT_MATCH_TEMPLATES };
