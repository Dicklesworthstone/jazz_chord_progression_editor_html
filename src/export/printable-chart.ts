...
export function encodePrintSvg(page:PrintPage):Readonly<{ok:true;bytes:Uint8Array<ArrayBuffer>}>|Readonly<{ok:false;message:string}>{
 const parts=[`<svg xmlns="http://www.w3.org/2000/svg" width="${String(page.width)}mm" height="${String(page.height)}mm" viewBox="0 0 ${String(page.width)} ${String(page.height)}"><title>JazzChords.org chord chart</title><metadata>${escapePrintXml(PRINT_FONT_LICENSE)}</metadata><style>@font-face{font-family:JazzChordsPrint;src:url(${PRINT_FONT_DATA});font-weight:400}text{text-rendering:geometricPrecision;font-family:JazzChordsPrint;font-weight:400;font-kerning:none;font-variant-ligatures:none;white-space:pre;fill:#111}rect{fill:none;stroke:#555;stroke-width:.2}</style><rect width="100%" height="100%" style="fill:white;stroke:none"/>`];
