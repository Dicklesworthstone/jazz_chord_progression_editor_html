...
enum JazzLibrary {
    ...
    static let entries: [LibraryEntry] = [
        ...
        LibraryEntry(id: "commendatore", title: "Don Giovanni, Commendatore", kicker: "MOZART · 1787", note: "D minor with diminished-seventh pivots—the chord Mozart uses to make the ground give way.", provenance: .publicDomain, chartText: "| Dm | C#dim7 | Dm | Gm6 | A7 | Dm | Bbmaj7 | A7 |", key: .d, tempo: 72, groove: .ballad),
        ...
        LibraryEntry(id: "chopin-chromatic", title: "Chromatic descent", kicker: "CHOPIN · 1839", note: "Romantic voice leading: the top line holds while inner voices slide by semitone beneath it.", provenance: .publicDomain, chartText: "| Em | B7 | Em | Am6 | Em/B | F#7 | B7 | Em |", key: .e, tempo: 74, groove: .ballad),
        LibraryEntry(id: "minor-blues", title: "Minor blues with backdoor", kicker: "BLUES TEMPLATE", note: "Minor blues closes through the backdoor cadence, avoiding the ordinary leading-tone arrival.", provenance: .device, chartText: "| Cm7 | Fm7 | Cm7 | Cm7 | Fm7 | Fm7 | Cm7 | Ebm7 Ab7 | Dm7b5 | G7b9 | Cm7 Bb7 | Cm7 |", key: .c, tempo: 136, groove: .mediumSwing),
        LibraryEntry(id: "modal-planing", title: "Modal planing", kicker: "MODAL DEVICE", note: "One voicing shape moves bodily up and down; the mode changes while the hand shape stays recognizable.", provenance: .device, chartText: "| Dm7 | Dm7 | Ebm7 | Ebm7 | Dm7 | Dm7 | Ebm7 Dm7 | Dm7 |", key: .d, tempo: 110, groove: .bossaNova),
        LibraryEntry(id: "chromatic-mediants", title: "Chromatic mediants", kicker: "LATE-ROMANTIC DEVICE", note: "Major sonorities a third apart share one tone—the harmonic hinge behind a great deal of film scoring.", provenance: .device, chartText: "| Cmaj7 | Abmaj7 | Emaj7 | Cmaj7 | Abmaj7 | Emaj7 | Fmaj7 | G7sus4 |", key: .c, tempo: 100, groove: .straightEighths),
        LibraryEntry(id: "mu-major-study", title: "Mu-major study", kicker: "ORIGINAL STUDY", note: "Add-nine major colors without the seventh create a bright, suspended studio sonority.", provenance: .study, chartText: "| Cadd9 | Aadd9 | Fadd9 | Gadd9 | Cadd9 Ebmaj7 | Dm9 | G13 | Cadd9 |", key: .c, tempo: 112, groove: .straightEighths),
        LibraryEntry(id: "lush-ballad-study", title: "Lush ballad study", kicker: "ORIGINAL STUDY", note: "Extended harmony keeps moving over a bass line that descends one careful step at a time.", provenance: .study, chartText: "| Fmaj7#11 | Em7 A7b9 | Dm9 | Db13 | Cmaj7 | Bm7b5 E7b9 | Am9 D13 | Gm7 C13 |", key: .f, tempo: 76, groove: .ballad),
        LibraryEntry(id: "gospel-blues-study", title: "Gospel-blues study", kicker: "ORIGINAL STUDY", note: "Plagal motion, a diminished pivot, and a walk-up to the turn connect church cadence language with blues harmony.", provenance: .study, chartText: "| Bbmaj7 | Ebmaj7 | Bbmaj7 | Bb7 | Ebmaj7 | Edim7 | Bb/F | Gm7 | Cm7 | F7b9 | Bbmaj7 G7b9 | Cm7 F7 |", key: .bb, tempo: 124, groove: .mediumSwing),
        LibraryEntry(id: "whole-tone-study", title: "Whole-tone approach", kicker: "ORIGINAL STUDY", note: "Augmented triads and altered dominants create a floating field before diatonic gravity returns.", provenance: .study, chartText: "| Caug | Daug | Caug | Fmaj7 | Bm7b5 E7b9 | Am7 | Dm7 G7 | Cmaj7 |", key: .c, tempo: 90, groove: .ballad),
