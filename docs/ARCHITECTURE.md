...
| `bun run validate:u5-contract` | validate the proposed independent U5 lifecycle-dialog inventory, replacement-confirmation matrix, startup/storage/marker/import/export/focus cases, traces, provenance, and mutation controls without claiming any U5 implementation |
