...
// Non-negative fit of the circular-tube sqrt(f) attenuation law. The values
// are normalized so `wall_loss_strength_per_second` is the attenuation rate
// at 1 kHz in a 6 mm-radius tube.
const WALL_LOSS_NORMALIZED_STRENGTHS: [f64; WALL_LOSS_POLES] =
    [0.272_783_56, 0.848_533_96, 3.161_245_66];
...
impl TrumpetParameters {
    ...
    pub const fn canonical() -> Self {
        Self {
            ...
            wall_loss_strength_per_second: 54.0,
